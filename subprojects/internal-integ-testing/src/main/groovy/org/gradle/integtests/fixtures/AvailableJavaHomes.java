...
public abstract class AvailableJavaHomes {
    ...
    private static List<JvmInstallationMetadata> discoverLocalInstallations() {
        ...
        DefaultJvmMetadataDetector.Factory defaultJvmMetadataDetectorFactory =
            new DefaultJvmMetadataDetector.Factory(execHandleFactory, temporaryFileProvider);
        JvmMetadataDetector metadataDetector = new CachingJvmMetadataDetector(defaultJvmMetadataDetectorFactory.create());
