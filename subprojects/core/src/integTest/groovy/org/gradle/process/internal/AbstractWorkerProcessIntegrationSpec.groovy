...
abstract class AbstractWorkerProcessIntegrationSpec extends Specification {
    ...
    final DefaultJvmMetadataDetector.Factory defaultJvmMetadataDetectorFactory = new DefaultJvmMetadataDetector.Factory(
    ...
    DefaultWorkerProcessFactory workerFactory = new DefaultWorkerProcessFactory(
        ...
        tmpDirTemporaryFileProvider,
        execHandleFactory,
        new DefaultJvmVersionDetector(new CachingJvmMetadataDetector(defaultJvmMetadataDetectorFactory.create())),
        outputEventListener,
        Stub(MemoryManager)
    )
